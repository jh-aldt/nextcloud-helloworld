...
namespace OCA\HelloWorld\Tests\Integration\Controller;

use OCA\HelloWorld\Controller\NoteController;
use OCA\HelloWorld\Db\Note;
use OCA\HelloWorld\Db\NoteMapper;
